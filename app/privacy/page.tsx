...
export default function Home() {
  return (
    <main className="min-h-screen w-full flex flex-col items-center bg-neutral-900 text-neutral-200 p-10">
      ...
      <section className="mt-12 w-full max-w-5xl font-mono bg-black border border-neutral-800 rounded-lg p-6 shadow-xl shadow-black/40">
        <p className="text-teal-400">
          marco@portfolio:~$ <span className="text-neutral-200">cat privacy.txt</span>
        </p><br />
        <b><h2>1. Datenschutz auf einen Blick</h2></b><br />
        <b><h3>Allgemeine Hinweise</h3></b>
        <p>
        ...
        <br />
        <b><h3>Datenerfassung auf dieser Website</h3></b>
        ...
        <br />
       <b><h4>Wie erfassen wir Ihre Daten?</h4></b>
        <p>
        ...
        <br />
        <b><h4>Wofür nutzen wir Ihre Daten?</h4></b>
        <p>
          ...
          können, werden die übermittelten Daten auch für Vertragsangebote, Bestellungen oder sonstige Auftragsanfragen verarbeitet.
        </p>
        <br />
        <b><h4>Welche Rechte haben Sie bezüglich Ihrer Daten?</h4></b>
        <p>
        ...
        <br />
        <b><h3>Analyse-Tools und Tools von Drittanbietern</h3></b>
        <p>
        ...
        <br />
        <b><h2>2. Hosting</h2></b><br />
        <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
        <b><h3>Hetzner</h3></b><br />
        <p>
        ...
        <br />
        <b><h4>Auftragsverarbeitung</h4></b>
        <p>
        ...
        <br />
        <b><h2>3. Allgemeine Hinweise und Pflichtinformationen</h2></b><br />
        <b><h3>Datenschutz</h3></b>
        <p>
        ...
        <br />
        <b><h3>Hinweis zur verantwortlichen Stelle</h3></b>
        ...
        <p>
          <a href="tel:+4901791023234">Telefon: +49 01791023234</a><br />
          <a href="mailto:marco@marcogiehmann.de">E-Mail: marco@marcogiehmann.de</a>
        </p><br />
        <p>
        ...
        <p>
          ...
          oder eine Einwilligung zur Datenverarbeitung widerrufen, werden Ihre Daten gelöscht, sofern wir keine anderen rechtlich zulässigen 
          Gründe für die Speicherung Ihrer personenbezogenen Daten haben (z. B. steuer- oder handelsrechtliche Aufbewahrungsfristen); 
          im letztgenannten Fall erfolgt die Löschung nach Fortfall dieser Gründe.
        </p>
        <br />
        <b><h3>Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3></b>
        <p>
          ...
          lit. a DSGVO bzw. Art. 9 Abs. 2 lit. a DSGVO, sofern besondere Datenkategorien nach Art. 9 Abs. 1 DSGVO verarbeitet werden. 
          Im Falle einer ausdrücklichen Einwilligung in die Übertragung personenbezogener Daten in Drittstaaten erfolgt die Datenverarbeitung 
          außerdem auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO. Sofern Sie in die Speicherung von Cookies oder in den Zugriff auf Informationen 
          in Ihr Endgerät (z. B. via Device-Fingerprinting) eingewilligt haben, erfolgt die Datenverarbeitung zusätzlich auf Grundlage von § 25 
          Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserfüllung oder zur Durchführung vorvertraglicher 
          ...
          Daten, sofern diese zur Erfüllung einer rechtlichen Verpflichtung erforderlich sind auf Grundlage von Art. 6 Abs. 1 lit. c DSGVO. 
        ...
        <br />
        <b><h3>Empfänger von personenbezogenen Daten</h3></b>
        <p>
          Im Rahmen unserer Geschäftstätigkeit arbeiten wir mit verschiedenen externen Stellen zusammen. Dabei ist teilweise auch eine Übermittlung 
          von personenbezogenen Daten an diese externen Stellen erforderlich. Wir geben personenbezogene Daten nur dann an externe Stellen weiter, 
          wenn dies im Rahmen einer Vertragserfüllung erforderlich ist, wenn wir gesetzlich hierzu verpflichtet sind (z. B. Weitergabe von Daten 
          an Steuerbehörden), wenn wir ein berechtigtes Interesse nach Art. 6 Abs. 1 lit. f DSGVO an der Weitergabe haben oder wenn eine sonstige 
          Rechtsgrundlage die Datenweitergabe erlaubt. Beim Einsatz von Auftragsverarbeitern geben wir personenbezogene Daten unserer Kunden nur auf 
          Grundlage eines gültigen Vertrags über Auftragsverarbeitung weiter. Im Falle einer gemeinsamen Verarbeitung wird ein Vertrag über gemeinsame 
          Verarbeitung geschlossen.
        </p>
        <br />
        <b><h3>Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3></b>
        <p>
        ...
        <br />
        <b><h3>Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3></b>
        <p>
        ...
        <br />
        <b><h3>Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3></b>
        <p>
        ...
        <br />
        <b><h3>Recht auf Datenübertragbarkeit</h3></b>
        <p>
        ...
        <br />
        <b><h3>Auskunft, Berichtigung und Löschung</h3></b>
        <p>
        ...
        <br />
        <b><h3>Recht auf Einschränkung der Verarbeitung</h3></b>
        <p>
        ...
        <br />
        <b><h3>SSL- bzw. TLS-Verschlüsselung</h3></b>
        <p>
        ...
        <br />
        <b><h2>4. Datenerfassung auf dieser Website</h2></b><br />
        <b><h3>Cookies</h3></b>
        <p>
          ...
          Session-Cookies werden nach Ende Ihres Besuchs automatisch gelöscht. Permanente Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese selbst löschen 
          oder eine automatische Löschung durch Ihren Webbrowser erfolgt.
        </p><br />
        <p>
          Cookies können von uns (First-Party-Cookies) oder von Drittunternehmen stammen (sog. Third-Party-Cookies). Third-Party-Cookies ermöglichen die Einbindung 
        ...
        <p>
          ...
          (z. B. die Warenkorbfunktion oder die Anzeige von Videos). Andere Cookies können zur Auswertung des Nutzerverhaltens oder zu Werbezwecken verwendet werden.
        </p><br />
        <p>
          Cookies, die zur Durchführung des elektronischen Kommunikationsvorgangs, zur Bereitstellung bestimmter, von Ihnen erwünschter Funktionen (z. B. für die Warenkorbfunktion) 
          ...
          sofern keine andere Rechtsgrundlage angegeben wird. Der Websitebetreiber hat ein berechtigtes Interesse an der Speicherung von notwendigen Cookies zur technisch fehlerfreien 
          und optimierten Bereitstellung seiner Dienste. Sofern eine Einwilligung zur Speicherung von Cookies und vergleichbaren Wiedererkennungstechnologien abgefragt wurde, erfolgt 
          die Verarbeitung ausschließlich auf Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG); die Einwilligung ist jederzeit widerrufbar.
        </p><br />
        <p>
          ...
          oder generell ausschließen sowie das automatische Löschen der Cookies beim Schließen des Browsers aktivieren. Bei der Deaktivierung von Cookies kann die Funktionalität dieser Website eingeschränkt sein.
        </p>
        <p>Welche Cookies und Dienste auf dieser Website eingesetzt werden, können Sie dieser Datenschutzerklärung entnehmen.</p>
        <br />
        <b><h3>Server-Log-Dateien</h3></b>
        <p>
        ...
        <p>
          Die Erfassung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an der technisch fehlerfreien 
          Darstellung und der Optimierung seiner Website – hierzu müssen die Server-Log-Files erfasst werden.
        </p>
        <br />
        <b><h3>Kontaktformular</h3></b>
        <p>
        ...
        <p>
          ...
          Maßnahmen erforderlich ist. In allen übrigen Fällen beruht die Verarbeitung auf unserem berechtigten Interesse an der effektiven Bearbeitung der an uns gerichteten Anfragen 
          (Art. 6 Abs. 1 lit. f DSGVO) oder auf Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO), sofern diese abgefragt wurde; die Einwilligung ist jederzeit widerrufbar.
        </p><br />
        <p>
